...
public class FaceSpot {
    ...
    //AppID，API Key，Secret Key。自己生成的
    private static final String AppID = "17645108";
    private static final String APIKey = "OBsQqQ5vefYCIvKGvGTyDGTg";
    private static final String SecretKey = "h3d5cmp5e2ZWFmXlSbzX3TvPRbtRe1ZQ";
...
/*    public static void main(String[] args) throws IOException {
        ...
        String file1 = "C:\\Users\\Administrator.DESKTOP-SOEB3B7\\Desktop\\cen.png";
        byte[] img2 = FileToByte(new File(file1));
//        System.out.println(addUser(img2,"BASE64","2","c5_face"));//添加人脸百度云的库中
        System.out.println(searchFace(img2, "c5_face","2"));//查询人脸
    }*/
/*
     *//**
     * 人脸检测
    ...
    *//**
    ...
    //注册方法
    public static JSONObject addFace(String imgStr, String groupId,String user_id) {
        //图片类型
        String imageType = "BASE64";
        HashMap<String, String> options = new HashMap<String, String>();
        options.put("quality_control", "NORMAL");
        options.put("liveness_control", "HIGH");
        options.put("max_user_num", "1");
        JSONObject res = client.addUser(imgStr, imageType, groupId,user_id, options);
        return res;
    }

    //人脸检测
    public static JSONObject detectFace(String imgStr) {
        //图片类型
        String imageType = "BASE64";
        // 传入可选参数调用接口
        HashMap<String, String> options = new HashMap<String, String>();
        options.put("face_field", "probability,glasses,race,face_token,eye_status,emotion,face_type");
    ...
    //在线活体检测
    public static JSONObject faceverifyFace(String imgStr) {
        FaceVerifyRequest req = new FaceVerifyRequest(imgStr, "BASE64","expression,face_shape,landmark,race,quality,face_type");
        ArrayList<FaceVerifyRequest> list = new ArrayList<FaceVerifyRequest>();
        list.add(req);
        JSONObject res = client.faceverify(list);
        return res;
    ...
    public static JSONObject sampleFace(String imgStr, String imgStr1) {
        // image1/image2也可以为url或facetoken, 相应的imageType参数需要与之对应。
        MatchRequest req1 = new MatchRequest(imgStr, "BASE64");
        MatchRequest req2 = new MatchRequest(imgStr1,"BASE64");
        ArrayList<MatchRequest> requests = new ArrayList<MatchRequest>();
        requests.add(req1);
        requests.add(req2);
        JSONObject res = client.match(requests);
