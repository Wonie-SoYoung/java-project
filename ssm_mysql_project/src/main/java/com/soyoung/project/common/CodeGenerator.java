...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        if (StringUtils.isNotEmpty(mapperPath)) {
            ...
            InjectionConfig cfg = new InjectionConfig() {
                ...
                public void initMap() {
                    ...
                    map.put("abc", this.getConfig().getGlobalConfig().getAuthor() + "Service");
                    this.setMap(map);
                }
            };
            mpg.setCfg(cfg);
        ...
        strategy.setInclude(scanner("表名,多个用英文逗号分割").replace("，", ",").split(","));
        strategy.setControllerMappingHyphenStyle(true);
        //继承自定义的controller，service，impl，dao
//        strategy.setSuperControllerClass("com.saasqs.common.base.BaseController");
//        strategy.setSuperServiceClass("com.saasqs.common.base.BaseService");
//        strategy.setSuperServiceImplClass("com.saasqs.common.base.BaseServiceImpl");
//        strategy.setSuperMapperClass("com.saasqs.common.base.BaseDao");
